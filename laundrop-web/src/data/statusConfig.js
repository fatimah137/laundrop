export const STATUS_CONFIG = {
  ...
  proses:    { label: 'Diproses',   color: '#8b5cf6', bg: '#ede9fe', text: '#5b21b6' }, // 👈 ganti diprocess
  siap:      { label: 'Siap',       color: '#10b981', bg: '#d1fae5', text: '#065f46' },
  delivery:  { label: 'Dikirim',    color: '#06b6d4', bg: '#cffafe', text: '#164e63' }, // 👈 ganti dikirim
  selesai:   { label: 'Selesai',    color: '#6366f1', bg: '#e0e7ff', text: '#3730a3' },
  cancelled: { label: 'Dibatalkan', color: '#ef4444', bg: '#fee2e2', text: '#991b1b' }, // 👈 ganti dibatalkan
};
